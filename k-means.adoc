...
image::https://github.com/ahmeterdem9603/k-means_kumeleme/blob/master/aaa.PNG[R]
image::https://github.com/ahmeterdem9603/k-means_kumeleme/blob/master/bbbb.PNG[R]
